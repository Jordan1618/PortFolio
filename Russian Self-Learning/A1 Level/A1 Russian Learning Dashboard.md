...
| **03 - Vocabulary**                       | 100 Essential Words Challenge [Vocabulary](Russian%20Self-Learning/Vocabulary.md)                                            | ✅ 100%         |
...
- **Verb Conjugation Groups:**
  - **Group I (-ать / -ять / -еть):** Mastery of endings (-ю, -ешь, -ет, -ем, -ете, -ют).
  - **Group II (-ить):** Specific patterns for second-group verbs + 11 irregulars.
- **Negation:** Placing the particle **Не** (nyé) directly before the verb.
...
- **[Vocabulary](Russian%20Self-Learning/Vocabulary.md):**  Reached point 51 (Slovar / Dictionnaire).
