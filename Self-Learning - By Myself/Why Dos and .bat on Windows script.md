...
- Now the real Dos doesn't exist anymore it has been the cmd.exe, the usual CLI.
- The .bat comes from the Batch langage. It's succesive Dos commands in a single script.